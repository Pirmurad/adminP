                ...
                <div class="col-lg-4">
                    <div class="card profile-card-2">
                        <div class="card-img-block">
                            <img class="img-fluid" src="assets/images/gallery/25.jpg" alt="Card image cap">
                        </div>
                        <div class="card-body pt-5">
                            <img src="assets/images/avatars/avatar-2.png" alt="profile-image" class="profile">
                            <h5 class="card-title">Sadiq Məmmədov</h5>
                            ...
                            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void();" data-target="#messages" data-toggle="pill"
                                       class="nav-link"><i class="icon-envelope-open"></i> <span class="hidden-xs">Messages</span></a>
                                </li>
                                <li class="nav-item">
